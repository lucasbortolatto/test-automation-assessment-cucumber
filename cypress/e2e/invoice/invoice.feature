Feature: Invoice Details
  ...
  Scenario: TC003 - Validate invoice details
    ...
    When User clicks on invoice details of item <invoiceTobeOpened> present on the table
    ...
    Examples:
            ...
            | invoiceTobeOpened | hotelName        | invoiceDate | duoDate    | invoiceNumber | bookingCode | customerDetails                                          | room            | checkIn    | checkOut   | totalStayCount | totalStayAmount | depositNow | taxAndVat | totalAmount |
            | 1                 | Rendezvous Hotel | 14/01/2018  | 15/01/2018 | #110          | 0875        | \n    \n    JOHNY SMITHR2, AVENUE DU MAROC123456\n    \n | Superior Double | 14/01/2018 | 15/01/2018 | 1              | $150            | USD $20.90 | USD $19   | USD $209    |
